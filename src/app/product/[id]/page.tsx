  ...
  interface Product {
    ...
    const getProductDetails = (prodId: string) => {
      ...
      const knownItems: Record<number, Product> = {
        ...
        901: { name: "Signature Cort Set 1", price: "₹1,050", image: "/images/cort set 1.jpeg", gallery: ["/images/cort set 1.jpeg"], description: "A highly sophisticated Cort Set featuring premium fabric and flawless tailoring, redefining modern traditional wear.", sizes: ["S", "M", "L", "XL"] },
        902: { name: "Signature Cort Set 2", price: "₹1,050", image: "/images/cort set 2.jpeg", gallery: ["/images/cort set 2.jpeg"], description: "A beautifully tailored Cort Set crafted for those who embrace luxury aesthetics and comfort. Perfect for elegant outings.", sizes: ["S", "M", "L", "XL"] },
        903: { name: "Signature Cort Set 3", price: "₹1,050", image: "/images/cort set 3.jpeg", gallery: ["/images/cort set 3.jpeg"], description: "Premium designer Cort Set blending traditional craftsmanship with contemporary flair. Features a flattering silhouette.", sizes: ["S", "M", "L", "XL"] },
        904: { name: "Signature Cort Set 4", price: "₹1,050", image: "/images/cort set 4.jpeg", gallery: ["/images/cort set 4.jpeg"], description: "Experience unmatched luxury with this exclusive Cort Set. The exquisite finish pairs perfectly with statement accessories.", sizes: ["S", "M", "L", "XL"] },
        905: { name: "Signature Cort Set 5", price: "₹1,050", image: "/images/cort set 5.jpeg", gallery: ["/images/cort set 5.jpeg"], description: "A masterclass in design, this premium Cort Set offers flawless draping and undeniable sophistication. A must-have exclusive.", sizes: ["S", "M", "L", "XL"] },
      };
