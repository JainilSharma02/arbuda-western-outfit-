...
const getProductDetails = (prodId: string) => {
  ...
  const knownItems: Record<number, Product> = {
    ...
    1552: {
      ...
      gallery: ["/images/2 pps1.jpeg", "/images/2 pps2.jpeg", "/images/2 pps3.jpeg", "/images/2 pps4.jpeg"],
             ...
             <div className="flex justify-between items-start mb-4">
              ...
              {numId === 1550 || numId === 1552 || numId === 1553 || numId === 1554 || numId === 1555 || numId === 1556 ? (
                <h1 className="text-3xl md:text-5xl font-serif font-black text-slate-900 mb-4 leading-tight capitalize">
                  2 piece <span className="bg-clip-text text-transparent bg-gradient-to-r from-[#b58b66] via-amber-500 to-[#b58b66] drop-shadow-sm select-none">{numId === 1550 ? "combo" : numId === 1552 ? "combo 2" : numId === 1553 ? "combo 3" : numId === 1554 ? "combo 4" : numId === 1555 ? "combo 5" : "combo 6"}</span>
                </h1>
              ) : (
