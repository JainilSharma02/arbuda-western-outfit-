    ...
    <AnimatePresence>
      {isVisible && (
        <>
          ...
          {/* Mobile Version - Compact & Non-Intrusive */}
          <div className="fixed bottom-24 right-6 z-[60] md:hidden flex flex-col gap-3 gpu">
            <motion.div 
            ...
            >
              <Link
                href="https://www.instagram.com/arbuda_western_outfit_end_dres?igsh=bTAyZTJzazk5NHo1"
                target="_blank"
                className="flex items-center justify-center w-10 h-10 rounded-full shadow-lg active:scale-90 transition-transform relative overflow-hidden backdrop-blur-sm"
              >
                <div className="absolute inset-0 bg-gradient-to-tr from-[#f09433] via-[#e6683c] to-[#bc1888] opacity-90" />
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-white z-10">
                  <rect width="20" height="20" x="2" y="2" rx="5" ry="5"/>
                  <path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/>
                  <line x1="17.5" x2="17.51" y1="6.5" y2="6.5"/>
                </svg>
            ...
            >
              <Link
                href="https://wa.me/919427673886"
                target="_blank"
                className="flex items-center justify-center w-11 h-11 bg-[#25D366] rounded-full shadow-lg active:scale-90 transition-transform relative"
              >
